...
// // Get property by ID with hierarchy support
...
//         const childCount = await Property.countDocuments({ parentId: id });
//         if (childCount > 0) {
//           return res.status(400).json({
//             success: false,
//             message:
//               "Cannot change parentId for main project with existing sub-properties",
//           });
//         }
//       }
//     }
...
//       await Property.updateMany({ parentId: id }, { isActive: false });
//     }
