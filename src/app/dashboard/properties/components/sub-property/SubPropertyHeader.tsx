// app/dashboard/properties/components/sub-property/SubPropertyHeader.tsx
"use client";
...
interface SubPropertyHeaderProps {
  property: Property;
  onClose: () => void;
...
const SubPropertyHeader: React.FC<SubPropertyHeaderProps> = ({
  property,
  onClose,
  primaryImageUrl,
  primaryImageLoading,
...
export default SubPropertyHeader;