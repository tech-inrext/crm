                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16, width: '100%', flex: 1 }}>
                      ...
                      <div style={{ width: '100%', maxWidth: 400 }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                          ...
                          {leadsBySourceMetrics.sourcesOrder.map((src, idx) => {
                            ...
                            return (
                              <div key={`${src}_${idx}`} style={{ display: 'flex', justifyContent: 'space-between', gap: 4, alignItems: 'center', padding: '8px 10px', borderRadius: 6, background: '#fff', border: '1px solid #f3f3f3' }}>
