...
// Analytics for schedule (weekly follow-ups)
export async function getSchedule({ employee }) {
  ...
  thisWeekFollowUps.forEach((lead) => {
    ...
    scheduleByDate[dateKey].push({
      ...
      followUpTime: followUpDate.toLocaleTimeString("en-US", { hour: "2-digit", minute: "2-digit", hour12: true }),
      assignedTo: lead.assignedTo
        ? { name: `${lead.assignedTo.firstName} ${lead.assignedTo.lastName}`, email: lead.assignedTo.email }
        : null,
